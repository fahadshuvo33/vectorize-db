...
Headers:
  X-DBMelt-Signature: sha256=abc123...
  X-DBMelt-Event: conversion.completed
...
Body:
{
  ...
  "data": {
    ...
    "download_url": "https://api.dbmelt.com/v1/files/xyz789/download"
  }
}
...
secret:
    ...
    User uses it to verify requests came from DBMelt
